"""
Django settings for avanzablog project.
...
SECRET_KEY = "django-insecure-lzbyo#slqjz+49mwnysqsnegly)j6-)ewfx+5ryi%89q#ywmya"
...
MIDDLEWARE = [
    ...
    'django.middleware.security.SecurityMiddleware',
    'django.contrib.sessions.middleware.SessionMiddleware',  # <-- This must be present
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
...
WSGI_APPLICATION = "avanzablog.wsgi.application"
